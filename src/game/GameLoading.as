package game
{
	...
	{
		private var _textFormat:TextFormat = new TextFormat("Segoe UI", 16, 0xFFFFFF, true);
		...
		override public function init():Boolean
		{
			...
			else { // No songs in queue? Something went wrong...
		...
		private function updatePreloader(e:Event):void
		{
			...
			if (song.loadFail)
			{
				...
				if (cancelLoadButton) cancelLoadButton.text = "Return";
