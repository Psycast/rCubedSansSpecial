package game {
	...
	public class GameOptions extends Object
	{
		...
		public function get isolation():Boolean { return isolationOffset > 0 || isolationLength > 0; }
		public function set isolation(value:Boolean):void { if (!value) isolationOffset = isolationLength = 0; }
		...
		public function fillFromReplay(r:Object = null):void
		{
			...
			if(settings["viewScore"] != null) displayScore = settings["viewScore"];
			if(settings["viewGameTopBar"] != null) displayGameTopBar = settings["viewGameTopBar"];
			if(settings["viewGameBottomBar"] != null) displayGameBottomBar = settings["viewGameBottomBar"];
