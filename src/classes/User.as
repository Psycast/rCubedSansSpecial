	...
	public class User extends EventDispatcher {
		...
		public function loadUserData(_data:Object):void {
			...
			if (isActiveUser) {
				...
				if (_data["song_ratings"] != null)		this.songRatings = _data["song_ratings"];
			}
		...
		public function set settings(_settings:Object):void {
			...
			if (_settings.language != null) 		this.language = _settings.language;
			if (_settings.viewOffset != null) 		this.GLOBAL_OFFSET = _settings.viewOffset;
			if (_settings.judgeOffset != null) 		this.JUDGE_OFFSET = _settings.judgeOffset;
			if (_settings.autoJudgeOffset != null) 	this.AUTO_JUDGE_OFFSET = _settings.autoJudgeOffset;
			if (_settings.viewSongFlag != null) 	this.DISPLAY_SONG_FLAG = _settings.viewSongFlag;
			if (_settings.viewJudge != null) 		this.DISPLAY_JUDGE = _settings.viewJudge;
			if (_settings.viewHealth != null) 		this.DISPLAY_HEALTH = _settings.viewHealth;
			if (_settings.viewGameTopBar != null) 	this.DISPLAY_GAME_TOP_BAR = _settings.viewGameTopBar;
			if (_settings.viewGameBottomBar != null)this.DISPLAY_GAME_BOTTOM_BAR = _settings.viewGameBottomBar;
			if (_settings.viewScore != null) 		this.DISPLAY_SCORE = _settings.viewScore;
			if (_settings.viewCombo != null) 		this.DISPLAY_COMBO = _settings.viewCombo;
			if (_settings.viewPACount != null) 		this.DISPLAY_PACOUNT = _settings.viewPACount;
			if (_settings.viewAmazing != null) 		this.DISPLAY_AMAZING = _settings.viewAmazing;
			if (_settings.viewPerfect != null) 		this.DISPLAY_PERFECT = _settings.viewPerfect;
			if (_settings.viewTotal != null) 		this.DISPLAY_TOTAL = _settings.viewTotal;
			if (_settings.viewScreencut != null) 	this.DISPLAY_SCREENCUT = _settings.viewScreencut;
			if (_settings.viewSongProgress != null) this.DISPLAY_SONGPROGRESS = _settings.viewSongProgress;
			if (_settings.viewMPMask != null) 		this.DISPLAY_MP_MASK = _settings.viewMPMask;
			if (_settings.viewMPTimestamp != null) 	this.DISPLAY_MP_TIMESTAMP = _settings.viewMPTimestamp;
			if (_settings.viewLegacySongs != null) 	this.DISPLAY_LEGACY_SONGS = _settings.viewLegacySongs;
			if (_settings.keys[0] != null) 			this.keyLeft = _settings.keys[0];
			if (_settings.keys[1] != null) 			this.keyDown = _settings.keys[1];
			if (_settings.keys[2] != null)			this.keyUp = _settings.keys[2];
			if (_settings.keys[3] != null) 			this.keyRight = _settings.keys[3];
			if (_settings.keys[4] != null) 			this.keyRestart = _settings.keys[4];
			if (_settings.keys[5] != null) 			this.keyQuit = _settings.keys[5];
			if (_settings.keys[6] != null) 			this.keyOptions = _settings.keys[6];
			if (_settings.noteskin != null) 		this.activeNoteskin = _settings.noteskin;
			if (_settings.direction != null) 		this.slideDirection = _settings.direction;
			if (_settings.speed != null) 			this.gameSpeed = _settings.speed;
			if (_settings.gap != null) 				this.receptorGap = _settings.gap;
			if (_settings.noteScale != null) 		this.noteScale = _settings.noteScale;
			if (_settings.screencutPosition != null)this.screencutPosition = _settings.screencutPosition;
			if (_settings.frameRate != null) 		this.frameRate = _settings.frameRate;
			if (_settings.songRate != null) 		this.songRate = _settings.songRate;
			if (_settings.forceNewJudge != null) 	this.forceNewJudge = _settings.forceNewJudge;
			if (_settings.visual != null) 			this.activeVisualMods = _settings.visual;
			if (_settings.judgeColours != null) 	this.judgeColours = _settings.judgeColours;
			if (_settings.comboColours != null) 	this.comboColours = _settings.comboColours;
			if (_settings.gameColours != null)		this.gameColours = _settings.gameColours;
			if (_settings.noteColours != null) 		this.noteColours = _settings.noteColours;
			if (_settings.gameVolume != null) 		this.gameVolume = _settings.gameVolume;
			if (_settings.isolationOffset != null) 	_avars.configIsolationStart = _settings.isolationOffset;
			if (_settings.isolationLength != null)	_avars.configIsolationLength = _settings.isolationLength;
			if (_settings.startUpScreen != null)	this.startUpScreen = Math.max(0, Math.min(2, _settings.startUpScreen));
			
			
			if (_settings.filters != null)			this.filters = doImportFilters(_settings.filters);
