package 
{
	...
	public class SQLQueries 
	{
		...
		{
			var params:Object = {"engine": (song.entry.engine != null ? song.entry.engine : "ffr"), "song_id": song.entry.level};
		 ...
		 * Gets stored song details using the following params structure:
			{
				"engine": "ffr", 			// Engine ID - String [250]
		...
		public static function saveSongDetails(conn:SQLConnection, params:Object, callback:Function = null):void
		{
			...
			if (!sqlState_saveSongDetails)
			{
				...
				sqlState_saveSongDetails.text = "INSERT OR REPLACE INTO `song_details` " +
					"	(`engine`, `song_id`, `offset_music`, `offset_judge`, `set_mirror_invert`, `set_custom_offsets`, `notes`) " +
					"VALUES " +
					"	(:engine, :song_id, :offset_music, :offset_judge, :set_mirror_invert, :set_custom_offsets, :notes)";
			}
