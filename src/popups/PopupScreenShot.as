...
package popups {
	...
	public class PopupScreenShot extends MenuPanel {
		...
		private var textFormat:TextFormat = new TextFormat("Segoe UI", 14, 0xFFFFFF, true);
		...
		override public function stageAdd():void {
			...
			if (results.error == null) {
				...
				if (results.error == "Imgur_Uploading")
					errorString = "Uploading to Imgur... Please Wait...";
				if (results.error == "Imgur_LimitReached")
					errorString = "You have reached your hourly upload limit.\nThis limit will reset in " + TimeUtil.convertToHHMMSS(results.refresh) + " minutes.";
				if (results.error == "Imgur_UploadFailed")
					errorString = "An error occured while uploading to \"Imgur\"\nThe server isn't responding."
				if (results.error == "FFR_Uploading")
					errorString = "Uploading to your FFR profile... Please Wait...";
				
				var errorText:Text = new Text(errorString, 16, "#FFFFFF");
				errorText.x = 5;
				errorText.y = 5;
				errorText.align = Text.CENTER;
				errorText.width = box.width - 87;
