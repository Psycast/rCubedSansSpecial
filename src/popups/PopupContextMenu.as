package popups {
	...
	public class PopupContextMenu extends MenuPanel {
		...
		override public function stageAdd():void {
			...
			//- Fullscreen
			/*
			cButton = new BoxButton(box.width - 10, cButtonHeight, "Save ScreenShot - Imgur");
			cButton.x = 5;
			cButton.y = yOff;
			cButton.action = "screenshotImgur";
			cButton.addEventListener(MouseEvent.CLICK, clickHandler);
			box.addChild(cButton);
			yOff += cButtonHeight + 5;
			
			//- Fullscreen
			cButton = new BoxButton(box.width - 10, cButtonHeight, "Save ScreenShot - FFR Photos");
			cButton.x = 5;
			cButton.y = yOff;
			cButton.action = "screenshotFFRPhoto";
			cButton.addEventListener(MouseEvent.CLICK, clickHandler);
			box.addChild(cButton);
			yOff += cButtonHeight + 5;
			*/
			...
			/*
			//- Options
			cButton = new BoxButton(box.width - 10, cButtonHeight, "Options");
			cButton.x = 5;
			cButton.y = yOff;
			cButton.action = "options";
			cButton.addEventListener(MouseEvent.CLICK, clickHandler);
			box.addChild(cButton);
			yOff += cButtonHeight + 5;
			*/
		...
		private function clickHandler(e:MouseEvent):void {
			...
			} else if (e.target.action == "screenshotImgur") {
