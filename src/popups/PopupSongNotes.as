package popups {
	...
	public class PopupSongNotes extends MenuPanel {
		...
		public function PopupSongNotes(myParent:MenuPanel, song:Object) {
			...
			SQLQueries.getSongDetails(_gvars.sql_conn, {"engine": (song.engine != null ? song.engine : "ffr"), "song_id": song.level}, function(result:Vector.<SQLSongDetails>):void {
		...
		{
			var params:Object = {
				"engine": (sObject["engine"] != null ? sObject["engine"] : "ffr"),
