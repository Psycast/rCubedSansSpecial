package arc.mp {
	...
	public class MultiplayerSingleton extends Object {
		...
		public function gameplayResults(gameResults:MenuPanel, songResults:Array):void {
			...
			var sendingScore:Boolean =	(room.match.status == Multiplayer.STATUS_RESULTS && (
												(connection.mode == Multiplayer.GAME_LEGACY && room.user.playerID == 1) ||
												(connection.mode == Multiplayer.GAME_VELOCITY && room.variables["gameScoreRecorded"] != "y")
											)
										);
		...
		public function gameplaySubmit(room:Object):void {
			...
			var convertNumber:Function = function(value:int):String { return velocity ? Multiplayer.dec2hex(value) : value.toString(); };
			...
			data.gamestats =	currentSong.name + ":" +
								convertNumber(results1.score) + ":" +
								convertNumber(results1.life) + ":" +
								convertNumber(results1.maxcombo) + ":" +
								convertNumber(results1.combo) + ":" +
								convertNumber(results1.amazing + results1.perfect) + ":" +
								convertNumber(results1.good) + ":" +
								convertNumber(results1.average) + ":" +
								convertNumber(results1.miss) + ":" +
								convertNumber(results1.boo) + ":" +
								currentSong.name + ":" +
								convertNumber(results2.score) + ":" +
								convertNumber(results2.life) + ":" +
								convertNumber(results2.maxcombo) + ":" +
								convertNumber(results2.combo) + ":" +
								convertNumber(results2.amazing + results2.perfect) + ":" +
								convertNumber(results2.good) + ":" +
								convertNumber(results2.average) + ":" +
								convertNumber(results2.miss) + ":" +
								convertNumber(results2.boo);
